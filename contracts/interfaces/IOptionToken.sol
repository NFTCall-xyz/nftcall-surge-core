...
interface IOptionToken {
    ...
    event OpenPosition(address indexed to, uint256 indexed positionId, OptionType optionType, uint256 strikeId, uint256 amount, uint256 maximumPremium);
    ...
    function openPosition(address to, OptionType optionType, uint256 strikeId, uint256 amount, uint256 maximumPremium) external returns(uint256 positionId);
